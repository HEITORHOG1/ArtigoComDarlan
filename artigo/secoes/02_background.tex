...
qualitative; quantitative extensions in the target journal of this
manuscript include Bayesian-network mapping
...
\citep{xie2021ressbowtie,sezer2023ressbowtie}. The approach adopted
here is complementary: each preventive barrier is mapped to a
deterministic indicator from the analytical sizing of the component
