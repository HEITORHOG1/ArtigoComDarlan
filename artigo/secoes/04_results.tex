...
performed by a Monte Carlo simulation with $N=2\times 10^{5}$
truncated-Gaussian draws of each input, with the three-sigma band set
...
a dedicated test rig --- specified in Section~\ref{sec:roadmap}
